...
/// A controller for the FeetRulerScale widget, allowing programmatic control.
class FeetRulerScaleController {
  /// A reference to the internal state of the FeetRulerScale widget.
  /// This is managed by the FeetRulerScale's State itself.
  _FeetRulerScaleState? _state;

  /// Attaches this controller to a FeetRulerScaleState.
  /// This method is called internally by the FeetRulerScaleState's initState.
  void _attach(_FeetRulerScaleState state) {
    _state = state;
  }

  /// Detaches this controller from a FeetRulerScaleState.
  /// This method is called internally by the FeetRulerScaleState's dispose.
  void _detach() {
    _state = null;
  }

  /// Jumps the ruler's indicator to a specific value.
  /// The value will be snapped to the nearest valid step as defined by the FeetRulerScale.
...
class FeetRulerScale extends StatefulWidget {
  ...
  final FeetRulerScaleController? controller;
  ...
  @override
  State<FeetRulerScale> createState() => _FeetRulerScaleState();
}

class _FeetRulerScaleState extends State<FeetRulerScale> {
  ...
  Widget build(BuildContext context) {
    ...
    // Calculate the total height/width of the FeetRulerScale widget
