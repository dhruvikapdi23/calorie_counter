...
class EatTimeSelection extends StatefulWidget {
  ...
  const EatTimeSelection({super.key, this.option, required this.onTap});
...
class _EatTimeSelectionState extends State<EatTimeSelection> {
  void _showTimePickerBottomSheet(BuildContext context,index) {
    showModalBottomSheet(
      ...
      if(value != null){
        AppArray.eatTime[index]["time"] =value;
        setState(() {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        spacing: 10,
        children: [
          ...AppArray.eatTime.asMap().entries.map(
            (e) => Container(
              ...
              child: Row(
                ...
                children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if(e.value['time'] !="")
                                    Text(
                                      e.value['time'],
                                      style: AppCss.soraSemiBold13.copyWith(color: AppColors.primaryColor),
                                    ).paddingSymmetric(horizontal: 10,vertical: 5).decorated(
                  ...
                  SvgPicture.asset(
                    e.value['time'] == "" ? AppSvg.addCircle : AppSvg.edit,
                  ).inkWell(
                    onTap: () {
                      _showTimePickerBottomSheet(context,e.key);
                    },
                  ),
                ],
              ),
            ).inkWell(onTap: () => widget.onTap(e.value)),
          ),
        ],
      ).paddingOnly(top: 32),
    );
